...
for col in days_cols:
    positive_mask = installments[col] >= 0
    installments.loc[positive_mask, col] = np.nan
...
installments_train_processed =  pipeline.fit_transform(installments_train, y_train)
